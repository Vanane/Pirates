    ...
    {
        public partial class InventoryRuntime : Pirates.GumRuntimes.ColoredRectangleRuntime
        {
            #region State Enums
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        GreenSecondValue = 128;
                        setHeightSecondValue = true;
                        HeightSecondValue = 450f;
                        if (interpolationValue >= 1)
                        {
                            this.HeightUnits = Gum.DataTypes.DimensionUnitType.Absolute;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.InventoryRuntime.VariableState fromState,Pirates.GumRuntimes.InventoryRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            	...
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "Inventory");
