    ...
    namespace Pirates.GumRuntimes
    {
        public partial class NineSliceRuntime : Gum.Wireframe.GraphicalUiElement
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.NineSliceRuntime.VariableState fromState,Pirates.GumRuntimes.NineSliceRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
