    ...
    {
        public partial class PasswordBoxRuntime : Pirates.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.PasswordBoxRuntime.VariableState fromState,Pirates.GumRuntimes.DefaultForms.PasswordBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.PasswordBoxRuntime.PasswordBoxCategory fromState,Pirates.GumRuntimes.DefaultForms.PasswordBoxRuntime.PasswordBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private void AssignReferences () 
            {
                ...
                {
                    FormsControl = new FlatRedBall.Forms.Controls.PasswordBox(this);
                }
            }
            ...
            public FlatRedBall.Forms.Controls.PasswordBox FormsControl {get; private set;}
