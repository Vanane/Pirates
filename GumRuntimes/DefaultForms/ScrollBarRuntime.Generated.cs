    ...
    {
        public partial class ScrollBarRuntime : Pirates.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ThumbInstance.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "ThumbContainer") ?? this;
                            SpriteInstance1.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "UpButtonInstance") ?? this;
                            SpriteInstance2.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "DownButtonInstance") ?? this;
                            BackgroundInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                            Height = 384f;
                            Width = 36f;
                            X = 0f;
                            Y = 0f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        ...
                        if (interpolationValue < 1)
                        {
                            this.SpriteInstance1.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "UpButtonInstance") ?? this;
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("SpriteInstance1.SourceFile", "UISpriteSheet.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.SpriteInstance2.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "DownButtonInstance") ?? this;
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("SpriteInstance2.SourceFile", "UISpriteSheet.png");
                        ...
                        if (interpolationValue < 1)
                        {
                            this.ThumbInstance.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "ThumbContainer") ?? this;
                        }
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState fromState,Pirates.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory fromState,Pirates.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private Pirates.GumRuntimes.DefaultForms.ButtonRuntime UpButtonInstance { get; set; }
            private Pirates.GumRuntimes.DefaultForms.ButtonRuntime DownButtonInstance { get; set; }
            private Pirates.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            private Pirates.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            private Pirates.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            private Pirates.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            public event FlatRedBall.Gui.WindowEvent ThumbContainerClick;
            ...
            private void AssignReferences () 
            {
                ...
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as Pirates.GumRuntimes.DefaultForms.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as Pirates.GumRuntimes.DefaultForms.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as Pirates.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as Pirates.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as Pirates.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as Pirates.GumRuntimes.ContainerRuntime;
                ...
                ThumbContainer.Click += (unused) => ThumbContainerClick?.Invoke(this);
