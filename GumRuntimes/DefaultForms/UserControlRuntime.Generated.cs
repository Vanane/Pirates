    ...
    {
        public partial class UserControlRuntime : Pirates.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ColoredFrameInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
                            Height = 300f;
                            Width = 300f;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.UserControlRuntime.VariableState fromState,Pirates.GumRuntimes.DefaultForms.UserControlRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            private void AssignReferences () 
            {
                ...
                {
                    FormsControl = new FlatRedBall.Forms.Controls.UserControl(this);
                }
            }
            ...
            public FlatRedBall.Forms.Controls.UserControl FormsControl {get; private set;}
