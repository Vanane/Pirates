    ...
    {
        public partial class ComboBoxRuntime : Pirates.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            SpriteInstance.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "NineSliceInstance") ?? this;
                            NineSliceInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                            TextInstance.CurrentColorCategoryState = Pirates.GumRuntimes.TextRuntime.ColorCategory.Gray;
                            Height = 48f;
                            Width = 250f;
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentComboBoxCategoryState)
                        {
                            ...
                            case  ComboBoxCategory.Disabled:
                                NineSliceInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                TextInstance.CurrentColorCategoryState = Pirates.GumRuntimes.TextRuntime.ColorCategory.Gray;
                                NineSliceInstance.Blue = 255;
                                NineSliceInstance.Green = 255;
                                NineSliceInstance.Red = 255;
                            ...
                            case  ComboBoxCategory.Highlighted:
                                NineSliceInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateFirstValue= Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateSecondValue= Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        ListBoxInstanceYFirstValue = 46f;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                        ...
                        if (interpolationValue < 1)
                        {
                            this.SpriteInstance.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "NineSliceInstance") ?? this;
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("SpriteInstance.SourceFile", "UISpriteSheet.png");
                        ...
                        TextInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        if (interpolationValue < 1)
                        {
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        ListBoxInstanceYSecondValue = 46f;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                        ...
                        TextInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        if (interpolationValue >= 1)
                        {
                            this.TextInstance.HorizontalAlignment = RenderingLibrary.Graphics.HorizontalAlignment.Left;
                        }
            ...
            public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState fromState,Pirates.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory fromState,Pirates.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private Pirates.GumRuntimes.DefaultForms.ListBoxRuntime ListBoxInstance { get; set; }
            private Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime NineSliceInstance { get; set; }
            private Pirates.GumRuntimes.TextRuntime TextInstance { get; set; }
            private Pirates.GumRuntimes.SpriteRuntime SpriteInstance { get; set; }
            ...
            {
                ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as Pirates.GumRuntimes.DefaultForms.ListBoxRuntime;
                NineSliceInstance = this.GetGraphicalUiElementByName("NineSliceInstance") as Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as Pirates.GumRuntimes.TextRuntime;
                SpriteInstance = this.GetGraphicalUiElementByName("SpriteInstance") as Pirates.GumRuntimes.SpriteRuntime;
                ListBoxInstance.Click += (unused) => ListBoxInstanceClick?.Invoke(this);
                if (tryCreateFormsObject)
                {
                    FormsControl = new FlatRedBall.Forms.Controls.ComboBox(this);
                }
            }
            ...
            public FlatRedBall.Forms.Controls.ComboBox FormsControl {get; private set;}
