    ...
    {
        public partial class RadioButtonRuntime : Pirates.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            SpriteInstance.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "ColoredFrameInstance") ?? this;
                            Height = 50f;
                            Width = 0f;
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentRadioButtonCategoryState)
                        {
                            case  RadioButtonCategory.EnabledOn:
                                ColoredFrameInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                            ...
                            case  RadioButtonCategory.DisabledOn:
                                ColoredFrameInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
                            ...
                            case  RadioButtonCategory.HighlightedOn:
                                ColoredFrameInstance.CurrentColorCategoryState = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        if (interpolationValue < 1)
                        {
                            this.SpriteInstance.Parent = this.ContainedElements.FirstOrDefault(item =>item.Name == "ColoredFrameInstance") ?? this;
                        }
                        if (interpolationValue < 1)
                        {
                            SetProperty("SpriteInstance.SourceFile", "UISpriteSheet.png");
            ...
            public void InterpolateBetween (RadioButtonCategory firstState, RadioButtonCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Pirates.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState fromState,Pirates.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Pirates.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory fromState,Pirates.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
